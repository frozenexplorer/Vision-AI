...
export const normalizeMaxInferenceFps = (value: unknown): number => {
...
export const normalizeInputResolution = (value: unknown): number[] => {
...
export const normalizeExecutionProviders = (value: unknown): string[] => {
